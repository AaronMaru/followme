        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><strong><?php echo $query->distr_desc_en; ?></strong> district of<strong><?php echo " " . $province->prvin_desc_en; ?></strong> Province</h5>
                ...
                <div class="ibox-content">
                    ...
                    <?php echo form_open('gps-syn/maps/district/update/', ['id' => 'latLng']); ?>
                        <input type="hidden" name="district_id" id="district_id" value="<?php echo $query->distr_id; ?>">
                        <input type="hidden" name="province_id" id="province_id" value="<?php echo $province->prvin_id; ?>">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Latitude</label>
                            <input type="text" name="distr_nu_latitude" class="form-control" id="newLat" value="<?php echo $query->distr_nu_latitude; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="distr_nu_longitude" class="form-control" id="newLng" value="<?php echo $query->distr_nu_longitude; ?>">
...
<script src="<?php echo base_url('assets/js/dashboard/maps/district.js'); ?>"></script>
